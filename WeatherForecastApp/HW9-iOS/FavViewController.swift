...
class FavViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    weak var FavVCDelegate: FavViewControllerDelegate?
    ...
    @IBOutlet weak var DeleteFav: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        let gesture = UITapGestureRecognizer(target: self, action:  #selector (self.deleteFromFav(_ :)))
        self.DeleteFav.addGestureRecognizer(gesture)
    ...
    @objc func deleteFromFav(_ sender:UITapGestureRecognizer){
        ...
        FavVCDelegate?.FavVCUpdate(FavVC: self, city: self.location?["city"] ?? " ")
    }
    ...
    @objc func jump2Details(_ sender:UITapGestureRecognizer){
        ...
        performSegue(withIdentifier: "detailsFav", sender: self)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: WeeklyTableCellTableViewCell = self.weekly_table.dequeueReusableCell(withIdentifier: "weekly_table_cell_fav") as! WeeklyTableCellTableViewCell
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "detailsFav" {
...
protocol FavViewControllerDelegate: class {
